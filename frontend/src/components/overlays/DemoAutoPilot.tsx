...
const DEMO_STEPS: DemoStep[] = [
    ...
    },
    {
        ...
        script: "\"Network Health Score: 73. Dublin Bus running at 80% on-time. 4 routes need attention. Every 15 seconds, live positions from NTA.\"",
    ...
    },
    {
        ...
        script: "\"Ghost buses, bunching — BusIQ doesn't just see them. It tells you what to do. HOLD bus #33017 for 90 seconds. DEPLOY from Broadstone. One click.\"",
    ...
    },
    {
        ...
        script: "\"Passengers report crowding — it feeds the Intervention Engine. 3 FULL reports on 39A? BusIQ auto-generates a SURGE intervention.\"",
        flyTo: { lat: 53.3498, lon: -6.2603, zoom: 13, pitch: 30, bearing: 0 },
    },
    {
        time: 120,
        mode: "smart-cities",
        title: "CITY ORCHESTRATOR",
        script: "\"Luas breaks down — BusIQ predicts the passenger surge and pre-positions buses. Cross-modal coordination. This journey saves 2.1kg of CO₂.\"",
